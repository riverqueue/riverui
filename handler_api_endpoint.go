...
const (
	stateCountAccuracyEstimated   stateCountAccuracy = "estimated"    // uses database planner/statistics estimate
...
// then a database planner/statistics estimate, and finally the bound proven by the index
