...
const TopNav = ({ children }: TopNavProps) => {
  ...
  return (
    <div className="sticky top-0 z-40 bg-white dark:bg-slate-900 lg:mx-auto lg:px-8">
      <div className="flex h-16 items-center gap-x-4 border-b border-slate-200 px-4 shadow-sm dark:border-slate-700 sm:gap-x-6 sm:px-6 lg:px-0 lg:shadow-none">
        <button
          type="button"
